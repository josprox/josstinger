...
<body>
  ...
  <?php
    if(isset($_POST['newfile'])){
      if(crear_archivo("routes/footer/footer.php","<?php //Aquí podrás editar tu footer ?>") == TRUE){
        ?>
    ...
    if(isset($_POST['deletefile'])){
      unlink(__DIR__ . "/../../routes/footer/footer.php");
    }
    if(!file_exists(__DIR__ . "/../../routes/footer/footer.php")){
      ...
      edit_file("Archivo footer global","./../../routes/footer/footer.php");
      ?>
        <center>
