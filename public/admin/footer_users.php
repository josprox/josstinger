...
<body>
  ...
  <?php
    if(isset($_POST['newfile'])){
      if(crear_archivo("routes/footer/footer_users.php","<?php //Aquí podrás editar tu footer de los usuarios ?>") == TRUE){
        ?>
    ...
    if(isset($_POST['deletefile'])){
      unlink(__DIR__ . "/../../routes/footer/footer_users.php");
    }
    if(!file_exists(__DIR__ . "/../../routes/footer/footer_users.php")){
      ...
      edit_file("Archivo footer de los usuarios","./../../routes/footer/footer_users.php");
      ?>
        <center>
