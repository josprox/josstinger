...
<body>
  ...
  <?php
      if(isset($_POST['newfile'])){
        if(crear_archivo("routes/navbar/navbar.php","<?php //Aquí podrás editar tu navbar ?>") == TRUE){
          ?>
      ...
      if(isset($_POST['deletefile'])){
        unlink(__DIR__ . "./../../routes/navbar/navbar.php");
      }
      if(!file_exists(__DIR__ . "/../../routes/navbar/navbar.php")){
        ...
        edit_file("Navbar del global","./../../routes/navbar/navbar.php");
        ?>
        <center>
