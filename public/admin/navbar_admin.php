...
<body>
  ...
  <?php
      if(isset($_POST['newfile'])){
        if(crear_archivo("routes/navbar/navbar_admin.php","<?php //Aquí podrás editar tu navbar del administrador ?>") == TRUE){
          ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            <strong>Felicidades</strong> Acabas de crear el archivo donde podrás editar tu navbar sin problemas.
          </div>
      ...
      if(isset($_POST['deletefile'])){
        unlink(__DIR__ . "/../../routes/navbar/navbar_admin.php");
      }
      if(!file_exists(__DIR__ . "/../../routes/navbar/navbar_admin.php")){
        ...
        edit_file("Navbar del administrador","./../../routes/navbar/navbar_admin.php");
        ?>
        <center>
