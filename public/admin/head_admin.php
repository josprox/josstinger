...
<body>
  ...
  <?php
    if(isset($_POST['newfile'])){
      if(crear_archivo("routes/head/head_admin.php","<?php //Aquí podrás editar tu head admin ?>") == TRUE){
        ?>
    ...
    if(!file_exists(__DIR__ . "/../../routes/head/head_admin.php")){
      ...
      edit_file("Archivo head del administrador","./../../routes/head/head_admin.php");
      ?>
        <center>
