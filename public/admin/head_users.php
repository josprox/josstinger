...
<body>
  ...
  <?php
    if(isset($_POST['newfile'])){
      if(crear_archivo("routes/head/head_users.php","<?php //Aquí podrás editar tu head de los usuarios ?>") == TRUE){
        ?>
    ...
    if(isset($_POST['deletefile'])){
      unlink(__DIR__ . "/../../routes/head/head_users.php");
    }
    if(!file_exists(__DIR__ . "/../../routes/head/head_users.php")){
      ...
      edit_file("Archivo head de los usuarios","./../../routes/head/head_users.php");
      ?>
        <center>
