...
$arr = array(
    "name" => $_ENV['NAME_APP'] . " Solution PWA: " . $_ENV['VERSION'],
    "short_name" => $_ENV['NAME_APP'],
    "description"=> "JosSecurity, la mejor seguridad al alcance de tus manos.",
    "background_color"=> "#fff",
    "theme_color"=> "#99eb91",
    "orientation"=> "portrait",
    "display" => "standalone",
    "start_url" => "./../panel?utm_source=web_app_manifest",
    "scope" => "./../panel",
    "lang" => "es-MX",
    "icons" => [
        [
